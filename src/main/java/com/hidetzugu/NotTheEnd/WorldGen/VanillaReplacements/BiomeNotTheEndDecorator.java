...
public class BiomeNotTheEndDecorator extends BiomeDecorator{

    /* Similar to BiomeEndDecorator but
     * with WorldGenNotTheEndSpikes instead of WorldGenSpikes
     */

    protected WorldGenerator spikeGen;
    private static final String __OBFID = "CL_00000188";

    public BiomeNotTheEndDecorator()
    {
        this.spikeGen = new WorldGenNotTheEndSpikes(Blocks.end_stone);
    }
