...
public class WorldGenNotTheEndSpikes extends WorldGenerator{

    /* Similar to WorldGenSpikes but
     * with a crystal spawner instead of bedrock
     */

    private Block field_150520_a;
    private static final String __OBFID = "CL_00000433";

    public WorldGenNotTheEndSpikes(Block p_i45464_1_)
    {
    ...
    public boolean generate(World p_76484_1_, Random p_76484_2_, int p_76484_3_, int p_76484_4_, int p_76484_5_)
    {
        if (p_76484_1_.isAirBlock(p_76484_3_, p_76484_4_, p_76484_5_) && p_76484_1_.getBlock(p_76484_3_, p_76484_4_ - 1, p_76484_5_) == this.field_150520_a)
        {
            ...
            p_76484_1_.setBlock(p_76484_3_, p_76484_4_ + l, p_76484_5_, ModBlocks.Crystal_Spawner, 0, 2);
            return true;
        }
        else
        {
