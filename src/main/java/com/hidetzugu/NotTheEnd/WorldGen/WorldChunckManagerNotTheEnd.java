...
public class WorldChunckManagerNotTheEnd extends WorldChunkManager{
    ...
    public WorldChunckManagerNotTheEnd(){
    ...
    public WorldChunckManagerNotTheEnd(BiomeGenBase p_i45374_1_, float p_i45374_2_)
    {
