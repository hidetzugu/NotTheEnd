...
public class blockEnderEmeraldOre extends blockNotTheEnd {

    public blockEnderEmeraldOre(){
        ...
        this.textureName="blockEnderEmeraldOre";
    }

    public static final String BLOCK_ID = "Ender_emerald_ore";
